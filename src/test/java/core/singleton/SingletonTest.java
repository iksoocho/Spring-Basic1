...
public class SingletonTest {
    ...
    void pureContainer(){
        ...
        AppConfig appConifg = new AppConfig();

        // 1. 조회 : 호출할 때 마다 객체를 생성
        MemberService memberService1 = appConifg.memberService();
    ...
    public void springContainer(){
        ...
        // 참조값이 같은 것을 확인
        System.out.println("memberService1 = " + memberService1);   // hello.core.member.MemberServiceImpl@4de41af9
        System.out.println("memberService2 = " + memberService2);   // hello.core.member.MemberServiceImpl@4de41af9
